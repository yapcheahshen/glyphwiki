...
var parse = function (str,key) {
				  ...
				  ii=parseInt(stk[j]);
					if (ii<0) {
					  ...
					  if (ii>=250) {
						  r.push(250);
							if (ii-250>255) {
							  console.error("integer too big "+ii);
							}
						  r.push(ii-250);
						} else {
            			  r.push(ii);
  ...
  return {bytearr:r, buhins:buhins};
}
...
module.exports={getBuhin:getBuhin,getBuhins:getBuhins,
	getGlyphGroup:getGlyphGroup,parse:parse,
	stringify:stringify}